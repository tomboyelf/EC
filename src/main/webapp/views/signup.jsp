...
<form action="Signup.action" method="post">
	...
	ユーザーネーム<input type="text" name="username" value="${notTrueFinalRealuser.username}" required>
	<c:choose>
	...
	苗字<input type="text" name="lastname" value="${notTrueFinalRealuser.lastname}" required>${signupErrorMsg004}<br>
	名前<input type="text" name="firstname" value="${notTrueFinalRealuser.firstname}" required>${signupErrorMsg005}<br>
